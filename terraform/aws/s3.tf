resource "aws_s3_bucket" "data" {
  ...
  tags = merge({
    ...
    git_commit           = "d58f6a85beb1c0afcf6e38de92e9bafaa4e9d8c4"
    git_file             = "terraform/aws/s3.tf"
    git_last_modified_at = "2022-05-05 20:08:09"
    git_last_modified_by = "lonkaut@gmail.com"
    git_modifiers        = "lonkaut/nimrodkor"
    git_org              = "dukekautington3rd"
    git_repo             = "terragoat-lon"
